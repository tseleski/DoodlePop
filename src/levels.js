...
export const startLevel = (game, levelNum) => {
  switch (levelNum) {
    ...
    case 2:
      ...
      break;
    case 3:
      game.addObject(new Bubble(game, 400, game.height / 3, 50, 3, 0, "green"));
      game.addObject(new Bubble(game, 200, game.height / 2, 25, -3, 0, "green"));
      game.addObject(new Bubble(game, 600, game.height / 2, 25, 3, 0, "green"));
      break;
    case 4:
      ...
      break;
    case 5:
      game.addObject(new Bubble(game, 200, game.height / 3, 100, 3, 0, "black"));
      break;
    case 6:
      game.addObject(new Bubble(game, 200, game.height / 3, 100, 3, 0, "black"));
